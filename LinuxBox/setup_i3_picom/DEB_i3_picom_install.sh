...
# -- internet 
# sudo apt install -y network-manager # comando nmcli 
# sudo apt install -y net-tools # comandos legados de internet iw ifconfig
...
# -- pós-instalação 
# fc-cache -fv # atualiza o cache de fontes (faça isso preferencialmente no tty)
# update-initramfs -u # atualiza initramfs para instalações que atualizam o kernel
