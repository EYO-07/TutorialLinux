...
Se o espaço não-alocado não estiver contido, porém adjacente a partição estendida, você pode utilizar o \textbf{gparted} para incluir o espaço não-alocado dentro da partição estendida. Lembre-se de fazer isso antes de usar o espaço para instalação, pois essa operação de estensão da partição estendida somente pode ser feita com espaços não-alocados adjacentes. \\ 
